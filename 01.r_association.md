...
위의 결과에서 규칙 2는 규칙 1에서 추가 지식을 제공하지 않습니다. 규칙 1은 모든 2 등급 아동이 살아남았다는 규칙입니다. 일반적으로 규칙 (예 : 규칙 2)이 다른 규칙의 수퍼 규칙 (예 : 규칙 1)이고 전자가 동일한 또는 낮은 리프트를 갖는 경우 이전 규칙 (규칙 2)은 중복되는 것으로 간주됩니다. 아래에서는 중복 규칙을 삭제합니다.(구글 번역 ㅜㅜ)
